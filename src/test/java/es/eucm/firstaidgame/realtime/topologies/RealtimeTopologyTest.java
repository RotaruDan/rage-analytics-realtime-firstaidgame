...
public class RealtimeTopologyTest {
    ...
    public void test() throws IOException {
        ...
        assertEquals("level3", player2.properties.get("accessed"));
    }
    ...
    public static class TestState extends ESGameplayState {
        ...
        public void setProperty(String versionId, String gameplayId,
            ...
            LOG.info("setPropertysetPropertysetPropertysetPropertysetPropertysetPropertysetPropertysetPropertysetPropertysetPropertysetPropertysetPropertysetPropertysetProperty" +
                    "versionId = [" + versionId + "], gameplayId = [" + gameplayId + "], key = [" + key + "], value = [" + value + "]");
